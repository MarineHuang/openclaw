          ...
          state.tab === "channels"
            ? lazyRender(lazyChannels, (m) =>
                m.renderChannels({
                  ...
                  feishuSetupBusy: state.feishuSetupBusy,
                  feishuSetupQrDataUrl: state.feishuSetupQrDataUrl,
                  feishuSetupMessage: state.feishuSetupMessage,
                  feishuSetupResult: state.feishuSetupResult,
                  feishuPairingRequests: state.feishuPairingRequests,
                  feishuPairingBusy: state.feishuPairingBusy,
                  feishuPairingError: state.feishuPairingError,
                  ...
                  onFeishuSetupStart: () => state.handleFeishuSetupStart(),
                  onFeishuSetupPoll: () => state.handleFeishuSetupPoll(),
                  onFeishuPairingList: () => state.handleFeishuPairingList(),
                  onFeishuPairingApprove: (code) => state.handleFeishuPairingApprove(code),
                }),
              )
            : nothing
        }
